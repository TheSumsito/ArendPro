...
<body>
    ...
    <center>
        ...
        <!-- FOTOS CREWUEL (TRABAJOS) -->
        <br>
        <div class="container">
            <br>
            <h2 class="titulo-pagina"><span style="color: red">Crewuel </span>Trabajados</h2>
        ...
        <!-- FOTOGRAFIAS CREWUEL (TRABAJOS) -->
        <div class="gallery">
            <div class="row">
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/06.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/07.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/08.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/01.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/02.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/03.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/04.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/05.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/09.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/010.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/011.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/crewuel/12.jpg" width="100%" data-lity></a>
                </div>
            </div>
        </div>
        <br>
