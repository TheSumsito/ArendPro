...
<body>
    ...
    <center>
        ...
        <!-- TITULOS CUADROS (TRABAJOS) -->
        <br>
        <div class="container">
            <br>
            <h2 class="titulo-pagina"> <span style="color: red">Cuadros </span>Trabajados</h2>
            <hr style="background-color: black">
        </div>


        <!-- FOTOGRAFICAS CUADROS -->
        <div class="gallery">
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/01.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/02.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/03.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/04.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/05.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/06.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/07.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/08.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/09.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/010.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/011.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/012.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/013.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/014.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/015.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/016.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/017.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/cuadros/018.jpg" width="100%" data-lity></a>
                </div>
            </div>
        </div>
        <br>
