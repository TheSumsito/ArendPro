...
<body>
    ...
    <center>
        ...
        <div class="container">
            <br>
            <h2 class="titulo-pagina"><span style="color: red">Oleos</span> Trabajados</h2>
        ...
        <div class="gallery">
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/01.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/02.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/03.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/04.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/05.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/06.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/07.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/08.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/09.jpeg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/010.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/011.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-4 col-sm-auto img-contenedor">
                    <a href=""><img src="static/img/oleo/012.jpg" width="100%" data-lity></a>
                </div>
            </div>
        </div>
        <br>
