...
<body>
    ...
    <center>
        ...
        <div class="container">
            <br>
            <h2 class="titulo-pagina"><span style="color: red">Cajas Decorativas </span>Trabajadas</h2>
            <hr style="background-color: black">
        </div>
        <br>


        <!-- FOTOGRAFIAS CAJAS DECORATIVAS (TRABAJOS) -->
        <div class="gallery">
            <div class="row">
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/01.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/02.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/03.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/09.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/05.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/06.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/04.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/08.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/07.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/010.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/011.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/012.jpg" width="100%" data-lity></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/013.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/014.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/015.jpg" width="100%" data-lity></a>
                </div>
                <div class="col-md-3 col-sm-6 img-contenedor">
                    <a href=""><img src="static/img/cajas_decorativas/016.jpg" width="100%" data-lity></a>
                </div>
            </div>
        </div>
        <br>
